                      ...
                      <tbody>
                          @foreach ($brands as $brand)
                              <tr>
                                ...
                                <td><a href="{{ route('brand.edit', $brand->id) }}" class="fa fa-pencil btn btn-primary" title="Edit data"></a>
                                    <a href="{{ route('brand.delete', $brand->id) }}" id="delete" class="fa fa-trash btn btn-danger" title="Delete data"></a>
                                </td>
                              </tr>
                          @endforeach
                      </tbody>
