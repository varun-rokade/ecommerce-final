                      ...
                      <tbody>
                          @foreach ($sub as $item)
                              <tr>
                                ...
                                <td width=30%><a href="{{ route('subcategory.edit', $item->id) }}" class="fa fa-pencil btn btn-primary" title="Edit data"></a>
                                    <a href="{{ route('subcategory.delete', $item->id) }}" id="delete" class="fa fa-trash btn btn-danger" title="Delete data"></a>
                                </td>
                              </tr>
                          @endforeach
                      </tbody>
