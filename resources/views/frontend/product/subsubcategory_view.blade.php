                    ...
                    <div class="accordion-group">
                      ...
                      <div class="accordion-body collapse" id="collapse{{ $item->id }}" style="height: 0px;">
                        <div class="accordion-inner">
                            ...
                            @php
                            $subsubcategories = App\Models\SubSubCategory::where('category_id', $item->id)->orderBy('subsubcategory_name_en', 'ASC')->get();
                            @endphp

                            @foreach ($subsubcategories as $subsub)
                          <ul>
                            <li><a class="nostyle" href="{{ url('subsubcategory/product/'.$subsub->id.'/'.$subsub->subsubcategory_slug_en ) }}">
                                @if (session()->get('language') == 'hindi')
