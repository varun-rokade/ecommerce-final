    ...
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 sidebar"> 
          ...
          <!-- ================================== TOP NAVIGATION ================================== -->
          @include('frontend.common.category_nav')
          <!-- /.side-menu --> 
          <!-- ================================== TOP NAVIGATION : END ================================== --> 
                            ...
                            <div class="product-info">
                              <h3 class="name"><a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en) }}">
                                ...
                                @if (session()->get('language') == 'hindi')
                                  <span style="font-size: 15px">{{ $product->product_name_hin }}</span>
                                @else
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder"> 
              ...
              <div class="item" style="background-image: url({{ asset($slider->image) }});">
                <div class="container-fluid">
                  <div class="caption bg-color vertical-center text-left">
                    ...
                    <div class="excerpt fadeInDown-2 hidden-xs"> <span>{{ $slider->des }}</span> </div>
                            ...
                            <div class="action">
                              <ul class="list-unstyled">
                                <li class="add-cart-button btn-group">
                                  ...
                                  <button data-toggle="modal" id="{{ $product->id }}" onclick="productView(this.id)" data-target="#exampleModal" class="btn btn-primary icon" type="button" title="Add to Cart"> <i class="fa fa-shopping-cart"></i> </button>

                                  <button class="btn btn-primary cart-btn" type="button">Add to cart</button>
                                </li>
                                {{-- <li class="lnk wishlist">  --}}
                                  <button id="{{ $product->id }}" onclick="addtowishlist(this.id)" class="btn btn-primary icon" type="button" title="Add to Wishlist">
              ...
              <div class="tab-pane" id="category{{ $category->id }}">
                <div class="product-slider">
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                    ...
                    @php
                        $cat = App\Models\Product::where('category_id', $category->id)->where('status', 1)->orderBy('id', 'DESC')->get();
                    @endphp
          ...
          <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">
              ...
              @if (session()->get('language') == 'hindi')
                                {{ $category1->category_name_hin }}
                              @else
                                {{ $category1->category_name_en }}
                              @endif
